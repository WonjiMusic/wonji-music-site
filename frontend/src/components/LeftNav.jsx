...
export default function LeftNav({ activeSection }) {
    ...
    return (
        <nav
            ...
            className="fixed left-0 top-0 h-screen w-16 md:w-20 z-30 flex flex-col items-center justify-between py-8 border-r border-[var(--line)]"
        >
            {/* Logo */}
            <div
                data-testid="nav-logo"
                className="font-display text-[22px] tracking-[0.2em] text-white select-none"
                style={{ writingMode: "horizontal-tb" }}
            >
                N<span style={{ color: "#6a00ff" }}>X</span>
            </div>
            ...
            <div className="flex flex-col gap-5 items-center text-[var(--text-dim)]">
                <a
                    ...
                    className="hover:text-white transition-colors duration-300 hover:drop-shadow-[0_0_6px_rgba(106,0,255,0.6)]"
                >
